...
const devWebpackConfig = {
  ...
  // these devServer options should be customized in env.param.config.js
  devServer: {
    /**
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      {
        from: utils.rootPath(config.dev.staticPath),
...
module.exports = merge(baseWebpackConfig, webpackCreateTemp, devWebpackConfig);
